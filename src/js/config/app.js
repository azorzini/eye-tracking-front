var eyetracking = angular.module('eyetracking', ['ngMaterial', 'ngAnimate', 'ngMessages', 'ngAria', 'ui.router', 'md.data.table',
    ...
    app.config(['$stateProvider', '$urlRouterProvider', '$qProvider', function($stateProvider, $urlRouterProvider, $qProvider) {
        ...
        .state('pacientes.record', {
            ...
            resolve: {
                ...
                estudiosvigentes: function (EstudiosVigentesServices){
                    return EstudiosVigentesServices.getEstudiosVigentes();
                }
            },
        })
        ...
        .state('estudiosvigentes', {
            abstract: true,
            url: '/estudiosvigentes',
            template: '<div ui-view class="page-transition"></div>'
        })



        .state('estudiosvigentes.list', {
            url: '/list',
            views: {
                "": {
                    templateUrl: 'partials/estudiosvigentes.html',
                    controller: 'EstudiosVigentesController',
                },
            },
            resolve : {
                estudiosvigentes: function (EstudiosVigentesServices){
