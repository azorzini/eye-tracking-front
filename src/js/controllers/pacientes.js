(function(app) {
    ...
    app.controller('PacientesRecordController', function($scope, $rootScope, $resource, $mdToast, $stateParams, _, $state, paciente, PacientesServices, $mdDialog, estudiosvigentes) {
        ...
        $scope.showEstudioDetails = function (ev, estudio, viewonly) {
            $mdDialog.show({
                ...
                escapeToClose: true,
                locals: {estudio: estudio, viewonly: viewonly, estudiosvigentes: $scope.estudiosvigentes},
                focusOnOpen: true
    ...
    .controller('EstudiosDialog', function ($scope, $mdDialog, estudio, viewonly, estudiosvigentes) {
        ...
        function querySearch (query) {
            var queriedEstudios = $scope.estudiosvigentes.filter( createFilterFor(query) );
            return query ?  queriedEstudios : $scope.estudiosvigentes;
        }
